...
export const comment = (() => {
    ...
    const comment = () => {
        ...
        const onNullComment = `<div class="text-center p-4 my-2 bg-theme-${theme.isDarkMode('dark', 'light')} rounded-4 shadow"><p class="fw-bold p-0 m-0" style="font-size: 0.95rem;">Belum Ada Ucapan dan doa di halaman ini </p></div>`;
